...
\setbeamertemplate{footline}{
  {\hfill\vspace*{1pt}\href{http://creativecommons.org/licenses/by-sa/3.0/legalcode}{\ccbysa}\hspace{.1cm}
    ...
    \href{https://git.adjemian.eu/stepan/growth/-/blob/\HEAD/cours/introduction.tex}{\gitrevision}\enspace\today
  }\hspace{1cm}}
...
\begin{frame}
  ...
  \framesubtitle{Les États Unis d'Amérique du Nord, I'}
  \begin{center}
    \input{../tikz/us-real-gdp-per-capita-level.tex}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \input{../tikz/fra-2-real-gdp-per-capita.tex}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \input{../tikz/uk-real-gdp-per-capita.tex}
  \end{center}
...
\begin{frame}
  ...
  \begin{Center}
    \input{../tikz/world-1950-2017.tex}
  \end{Center}
...
\begin{frame}
  ...
  \begin{Center}
    \input{../tikz/world-1960-2000.tex}
  \end{Center}
...
\begin{frame}
  ...
  \begin{center}
    \input{../tikz/density-1960-2000.tex}
  \end{center}
